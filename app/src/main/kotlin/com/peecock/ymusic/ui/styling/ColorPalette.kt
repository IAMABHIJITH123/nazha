...
data class ColorPalette(
    ...
    companion object : Saver<ColorPalette, List<Any>> {
        override fun restore(value: List<Any>) = when (val accent = value[0] as Int) {
            ...
            4 -> NazhaMidnightColorPalette
            5 -> NazhaNeonColorPalette
        ...
        override fun SaverScope.save(value: ColorPalette) =
            listOf(
                when {
                    ...
                    value === NazhaMidnightColorPalette -> 4
                    value === NazhaNeonColorPalette -> 5
...
val NazhaMidnightColorPalette = ColorPalette(
    background0 = Color(0xff0e0e1b), // Deep midnight blue/black
    background1 = Color(0xff18192d), // Glass-card dark blue
    background2 = Color(0xff22243e), // Glass-card highlight
    background3 = Color(0xff3a3c5a),
    background4 = Color(0xff2b2d4f),
    text = Color(0xffffffff),
    textSecondary = Color(0xffa1a2c3),
    textDisabled = Color(0xff5c5d7a),
    iconButtonPlayer = Color(0xfffdb813), // Golden/yellow-orange accents
    accent = Color(0xfffdb813),
    onAccent = Color.Black,
    isDark = true
)

val NazhaNeonColorPalette = ColorPalette(
    background0 = Color(0xff080c09), // Blackish-green
    background1 = Color(0xff111812), // Dark card forest green
    background2 = Color(0xff1b261d), // Medium card green
    background3 = Color(0xff2d3c30),
    background4 = Color(0xff243026),
    text = Color(0xfff2fdf4),
    textSecondary = Color(0xff8aa591),
    textDisabled = Color(0xff506b57),
    iconButtonPlayer = Color(0xff1db954), // Spotify-like neon green
...
fun colorPaletteOf(
    ...
    return when (colorPaletteName) {
        ...
        ColorPaletteName.NazhaMidnight -> NazhaMidnightColorPalette
        ColorPaletteName.NazhaNeon -> NazhaNeonColorPalette
    }
}
